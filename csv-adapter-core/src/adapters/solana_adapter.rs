...
impl ChainAdapter for SolanaAdapter {
    ...
    async fn create_client(&self, _config: &ChainConfig) -> ChainResult<Box<dyn RpcClient>> {
        ...
        Err(ChainError::NotImplemented(
            "Solana RPC client creation".to_string(),
        ))
    }
    ...
    async fn create_wallet(&self, _config: &ChainConfig) -> ChainResult<Box<dyn Wallet>> {
        ...
        Err(ChainError::NotImplemented(
            "Solana wallet creation".to_string(),
        ))
    }
...
impl RpcClient for SolanaRpcClient {
    ...
    async fn get_transaction(
        &self,
        _hash: &str,
    ) -> crate::chain_adapter::ChainResult<serde_json::Value> {
    ...
    async fn is_transaction_confirmed(
        &self,
        _hash: &str,
    ) -> crate::chain_adapter::ChainResult<bool> {
        Err(ChainError::NotImplemented(
            "is_transaction_confirmed".to_string(),
        ))
    }
...
impl Wallet for SolanaWallet {
    ...
    fn import_from_private_key(&self, _private_key: &str) -> ChainResult<()> {
        Err(ChainError::NotImplemented(
            "import_from_private_key".to_string(),
        ))
    }
}
